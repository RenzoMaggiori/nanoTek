...
nts::Chipset4512::Chipset4512() {
    ...
    this->_pins[1] = static_cast<SelectorComponent*>(this->_components[1].get())->getPins()[1];
    this->_pins[2] = static_cast<SelectorComponent*>(this->_components[1].get())->getPins()[2];
    this->_pins[3] = static_cast<SelectorComponent*>(this->_components[1].get())->getPins()[3];
    this->_pins[4] = static_cast<SelectorComponent*>(this->_components[1].get())->getPins()[4];
    this->_pins[5] = static_cast<SelectorComponent*>(this->_components[1].get())->getPins()[5];
    ...
    this->_pins[15] = static_cast<SelectorComponent*>(this->_components[1].get())->getPins()[15];
    this->_pins[10] = static_cast<SelectorComponent*>(this->_components[1].get())->getPins()[10];
    this->_pins[14] = static_cast<SelectorComponent*>(this->_components[1].get())->getPins()[14];
}